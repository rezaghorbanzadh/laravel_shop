        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons ti ti-layout-grid"></i>
                    <div data-i18n="Layouts">دسته بندی</div>
                </a>
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="{{route("admin.user.index")}}" class="menu-link">
                            <div data-i18n="Collapsed menu">کاربران عادی</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{route("admin.user.adminUser")}}" class="menu-link">
                            <div data-i18n="Content navbar">   کاربران ادمین</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="layouts-content-navbar-with-sidebar.html" class="menu-link">
